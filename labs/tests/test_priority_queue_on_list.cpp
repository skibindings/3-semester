...
int main() {
    cout << "Create PriorityQueueOnList named queue" << endl;
    PriorityQueueOnList queue;

    cout << "Push 2, -3 and 6 in queue" << endl;
    queue.push(2.0f);
    queue.push(-3.0f);
    queue.push(6.0f);
    ...
    cout << "Create new PriorityQueueOnList named queue2 "
            "using copy constructor (copying queue)" << endl;
    PriorityQueueOnList queue2(queue);
